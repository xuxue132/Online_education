        ...
        <div class="content row">
            <div class="sub_left">
                ...
                <ul class="flag2 sub_menu">
                    ...
                    <li>
                        <a  title="公告列表" href="/NoticePage" class="chs">公告列表</a>
                    </li>
            ...
            <div class="sub_right">
                <div class="bread fs14">
                    ...
                    &nbsp;-&nbsp;
                    <a href="/NoticePage">公告列表</a>
                </div>
                <div class="page_content">
                    <div class="page_title">
                        <h3 class="fs24">公告列表</h3>
                    </div>
                </div>
                ...
                <div>
                    <div class="lists">
                        <ul v-for="Notice in Notices">
                            <li >
                                <a class="info" @click="TurnPage(Notice.id,Notice.type)">
                                    <div class="time fs14">{{Notice.dates}}</div>
                                    <div class="title fs16">{{Notice.title}}</div>
                                </a>
                            </li>
                        </ul>
                    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            TurnPage(id,types) {
                // this.$router.push({path: '/NewText', query:{id: id,types: types}});
                ...
                this.$axios.post('public/NewNoticeHit', {
                    id: id
                }, {
                    headers: {'Authorization': this.$store.state.Authorization}
                }).then(resp => {
